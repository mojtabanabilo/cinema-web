...
const VmDrama = ({fav}) => {
    ...
    return (
        <div className='cards' data-aos="fade-left" data-aos-delay="100">
            ...
            {
                newDrama[5] ? newDrama[5].map(i => <div key={i.id} className='card'>
                    ...
                    <div className='votes'>
                        ...
                        </div>
                        {
                            star === false ? <img src={whiteStar} className='stars' alt='stars' onClick={() => {
                                setStar(true);
                                starHandler(newDrama[5] ,i.id)
                                if(starHandler) setFavorite(prev => [...prev, starHandler(newDrama[5] ,i.id)])
                            }}/> : 
